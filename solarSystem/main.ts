namespace SolarSystem {
    ...
    function createCelestialBodies(): void {
        ...
        const mercury: CelestialBody = new CelestialBody(mercuryA, "mercury", mercuryInfo, mercuryText, "orange", 10, 0, 5, 700);
        const venus: CelestialBody = new CelestialBody(venusA, "venus", venusInfo, venusText, "blue", 10, 0, 7, 800);
