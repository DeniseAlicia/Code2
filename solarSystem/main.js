...
(function (SolarSystem) {
    ...
    function createCelestialBodies() {
        ...
        const uranus = new SolarSystem.CelestialBody("Uranus", SolarSystem.uranusInfo, SolarSystem.uranusText, "green", 15, 0, earthSpeed * 0.01, 420);
        const neptun = new SolarSystem.CelestialBody("Neptun", SolarSystem.neptunInfo, SolarSystem.neptunText, "blue", 15, 0, earthSpeed * 0.006, 450);
        const pluto = new SolarSystem.CelestialBody("Pluto", SolarSystem.plutoInfo, SolarSystem.plutoText, "grey", 5, 0, earthSpeed * 0.004, 480);
        ...
        const oberon = new SolarSystem.CelestialBody("Oberon", SolarSystem.oberonInfo, SolarSystem.oberonText, "white", 4, 0, earthSpeed * 27.1, 20);
